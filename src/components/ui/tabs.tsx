/**
 * Tabs component - Simple wrapper around Radix Tabs
 */
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-sunken p-1 text-fg-3",
      className,
    )}
    {...props}
  />
