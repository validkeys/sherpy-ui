...
describe("BUG-010: Gap Analysis form data not captured", () => {
  ...
  beforeEach(() => {
    ...
    console.log(
      "[BUG-010 Test] localStorage mocked. Initial length:",
  ...
  it("REPRODUCTION: should capture form data in context.step1Responses after submit", async () => {
    console.log(
      "[BUG-010 Test] ===== TEST START: Form data capture reproduction =====",
    );
    ...
    console.log(
      "[BUG-010 Test] FormStep mounted, waiting for initial state...",
    );
    ...
    await user.type(
      descriptionTextarea,
      "Comprehensive healthcare portal with patient records",
    );
    ...
    await waitFor(
      () => {
        ...
        if (!updatedState) {
          console.error(
            "[BUG-010 Test] ❌ localStorage key missing after submit",
          );
        ...
        console.log("[BUG-010 Test] State after submit:", {
          ...
          hasResponses:
            Object.keys(parsed.context.step1Responses || {}).length > 0,
        });
        ...
        if (!responses || Object.keys(responses).length === 0) {
          console.error(
            "[BUG-010 Test] ❌ BUG REPRODUCED: step1Responses is empty!",
          );
          console.error(
            "[BUG-010 Test] Expected existingRequirements and projectDescription",
          );
        ...
        expect(responses.existingRequirements).toBe(
          "No, starting from scratch",
        );
        expect(responses.projectDescription).toBe(
          "Comprehensive healthcare portal with patient records",
        );
      },
      { timeout: 3000 },
  ...
  it("should verify SUBMIT_FORM event payload includes form data", async () => {
    console.log(
      "[BUG-010 Test] ===== TEST START: Event payload verification =====",
    );
  ...
  it("should verify machine assigns step1Responses from event.responses", async () => {
    console.log(
      "[BUG-010 Test] ===== TEST START: Machine assign verification =====",
    );
    ...
    console.log(
      "[BUG-010 Test] Initial context.step1Responses:",
      initialSnapshot.context.step1Responses,
    );
    ...
    await waitFor(
      () => {
        ...
        console.log(
          "[BUG-010 Test] Updated context.step1Responses:",
          responses,
        );
