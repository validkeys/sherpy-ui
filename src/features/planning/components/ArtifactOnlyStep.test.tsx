...
describe('ArtifactOnlyStep', () => {
  ...
  describe('Initial state', () => {
    it('renders step name', () => {
      ...
      expect(screen.getByRole('heading', { name: /architecture decisions/i })).toBeDefined();
    });
    ...
    it('shows waiting message when no artifact', () => {
      ...
      expect(screen.getByText(/waiting for artifact generation/i)).toBeDefined();
    });
  ...
  describe('View mode', () => {
    ...
    it('shows waiting message in initial state', () => {
      ...
      const waitingMessage = screen.getByText(/waiting for artifact generation/i);
  ...
  describe('Step number', () => {
    ...
    it('works regardless of stepKey prop', () => {
      ...
      render(
        <PlanningMachineProvider input={defaultInput}>
          <ArtifactOnlyStep stepKey="different_key" stepName="Architecture Decisions" />
        </PlanningMachineProvider>
      );
  ...
  describe('Component structure', () => {
    ...
    it('renders heading as h2', () => {
      ...
      const heading = screen.getByRole('heading', { name: /architecture decisions/i });
