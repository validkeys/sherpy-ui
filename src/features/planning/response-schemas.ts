...
export const INTERVIEW_QUESTION_SCHEMA = {
  ...
  "type": "object",
  "description": "Interview question with multiple-choice options for user selection. The question should be clear and focused, with options providing distinct choices.",
  "properties": {
    "question": {
      "type": "string",
      "description": "The question text to display to the user. MUST NOT include the options list - options are provided separately in the 'options' array. Keep this clean and focused on the question itself."
    },
    "options": {
      "type": "array",
      "description": "Array of multiple-choice options for the user to select from. Typically 2-4 options.",
      "items": {
        "type": "object",
        ...
        "properties": {
          "letter": {
            "type": "string",
            "description": "Option identifier (e.g., 'A', 'B', 'C'). Used for user selection.",
            "pattern": "^[A-Z]$"
          },
          "title": {
            "type": "string",
            "description": "Short title for the option (1-5 words). Displayed prominently in the UI."
          },
          "body": {
            "type": "string",
            "description": "Detailed explanation of this option (1-3 sentences). Helps user understand implications."
          },
          "recommended": {
            "type": "boolean",
            "description": "Whether this option is recommended for the user. Only one option should be marked as recommended."
          }
        },
    ...
    "isComplete": {
      "type": "boolean",
      "description": "Whether this step is complete and no more questions are needed. When true, the step will transition to the next phase."
    }
  },
...
export const ARTIFACT_RESPONSE_SCHEMA = {
  ...
  "properties": {
    "content": {
      "type": "string",
      "description": "The generated artifact content (YAML or Markdown). Must be valid syntax for the specified format."
    },
    "format": {
      "type": "string",
      "enum": ["yaml", "markdown"],
