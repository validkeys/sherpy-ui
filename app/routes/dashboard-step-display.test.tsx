...
describe('Bug #002: Project State Display Mismatch', () => {
  ...
  it('exposes bug: dashboard shows Step 2 from Project.currentStep, but planning machine state is at Step 1', async () => {
    ...
    const DashboardComponent = (Route as any).options.component as React.ComponentType;
    ...
    const storedState = JSON.parse(localStorageMock.getItem('planning-machine-seed-0002')!);
