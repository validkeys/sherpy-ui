...
function Box({
  ...
  return (
    <div
      ...
      onMouseEnter={
        hover
          ? (e) => (e.currentTarget.style.background = "var(--neutral-1)")
          : undefined
      }
      onMouseLeave={
        hover
          ? (e) => (e.currentTarget.style.background = fill || "transparent")
          : undefined
      }
    >
      {children}
      ...
      {phases.map((p) => {
        ...
        return (
          ...
          >
            ...
            {isActive && (
              <Note rotate={-4} style={{ fontSize: 13 }}>
                here
              </Note>
            )}
          </div>
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      <svg
        ...
        viewBox="0 0 24 24"
        fill="none"
        style={{ filter: "url(#pencil-soft)" }}
      >
        <path
          d="M3 19 L11 7 L19 19 Z"
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      <div style={{ display: "flex", alignItems: "baseline", gap: 12 }}>
        ...
        <div style={{ flex: 1 }}>
          <div
            style={{ fontSize: 14, fontWeight: 500, color: "var(--neutral-7)" }}
          >
            {title}
          </div>
          {subtitle && (
...
function AppChrome({
  ...
  showRail = true,
  density = "cozy",
  railVariant = "pipeline",
}) {
  return (
    <div
      style={{
        display: "grid",
        gridTemplateColumns: showRail ? "180px 1fr" : "1fr",
        height: "100%",
      }}
    >
      {showRail &&
        (railVariant === "workspace" ? (
          ...
          >
            <Brand size={18} />
            <div>
              <Eyebrow style={{ marginBottom: 6, paddingLeft: 4 }}>
                Project
              </Eyebrow>
              <div
                style={{
...
function WorkspaceRail() {
  return (
    ...
    >
      ...
      <div>
        <Eyebrow style={{ marginBottom: 4, paddingLeft: 4 }}>
          Recent runs
        </Eyebrow>
      ...
      >
        ...
        >
          <span style={{ fontSize: 11, color: "var(--neutral-7)" }}>
            Kyle Welsby
          </span>
          <span
            style={{
    ...
    >
      ...
      <span
        style={{
          ...
          whiteSpace: "nowrap",
          fontFamily: dot ? "var(--font-mono)" : "var(--font-sans)",
        }}
      >
        {label}
      </span>
...
function SpectrumBar({
  ...
  return (
    <div
      style={{
        padding: density === "compact" ? "10px 24px 8px" : "14px 32px 10px",
        flexShrink: 0,
      }}
    >
      <div
      ...
      >
        {phases.map((p) => {
          ...
          return (
            <div
              key={p.n}
              title={`${String(p.n).padStart(2, "0")} · ${p.name}`}
              style={{
                flex: 1,
                background: p.c,
                opacity: op,
                borderRadius: 2,
                boxShadow: now
                  ? `0 0 0 1px rgba(255,255,255,0.6) inset, 0 0 10px ${p.c}`
                  : "none",
                cursor: "pointer",
              }}
            />
    ...
    >
      ...
      <div
        style={{
          display: "flex",
          flexDirection: "column",
          gap: density === "compact" ? 5 : 7,
        }}
      >
        <Eyebrow color="var(--neutral-5)">
          Suggested answers · pick or edit
        </Eyebrow>
        {suggestions.map((s, i) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          style={{ fontSize: 10, color: "var(--neutral-5)", cursor: "pointer" }}
        >
          collapse ×
        </span>
      </div>
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        ...
        <div style={{ fontSize: 12.5, color: "var(--neutral-7)" }}>
          What's the difference between an "outcome" and an "acceptance
          criterion"?
        </div>
      </div>
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        ...
        >
          An outcome is the user-visible change you want — measurable, often a
          metric. An acceptance criterion is a binary check that proves the
          outcome is met. Outcomes belong in{" "}
          <code
            style={{
              fontFamily: "var(--font-mono)",
              fontSize: 11.5,
      ...
      <div
        style={{
          border: "1.5px dashed var(--neutral-4)",
          borderRadius: 4,
          padding: "6px 8px",
          fontSize: 11.5,
          color: "var(--neutral-5)",
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
        <Frame
          label="A"
          title="Blank state — pick your starting point"
          subtitle="Outside the run. Pre-flight only."
          w={fw}
          h={fh}
        >
        ...
        <Frame
          label="B"
          title="Intake captured — about to start gap analysis"
          subtitle="Doc pasted. Spectrum bar shows nothing-done-yet."
          w={fw}
          h={fh}
        >
      ...
      <SubHeader
        n="Gap analysis cycle"
        hint="Worksheet generated → filled offline → uploaded → merged. Skip-to-interview is one click away the whole time."
      />
      <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
        <Frame
          label="C"
          title="Gaps worksheet generated"
        ...
        <Frame
          label="D"
          title="Awaiting filled worksheet"
        ...
        <Frame
          label="E"
          title="Merging answers into the worksheet"
        ...
        <Frame
          label="F"
          title="Worksheet updated — ready for the interview"
      ...
      <SubHeader
        n="Business interview"
        hint="Same shell, phase 02. Composer pinned, suggestions live in the composer."
      />
      <div style={{ display: "flex", gap: 28, flexWrap: "wrap" }}>
        <Frame
          label="G"
          title="Mid-interview — Q&A thread"
        ...
        {showAskback && (
          <Frame
            label="H"
            title="Ask-back inline above the composer"
  ...
  return (
    <div
      style={{
        ...
        marginTop: 6,
        paddingBottom: 8,
        borderBottom: "1px dashed var(--neutral-3)",
      }}
    >
      <span
        style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          sherpy-web <span style={{ color: "var(--neutral-4)" }}>/</span>{" "}
          <span style={{ color: "var(--neutral-7)" }}>new run</span>
        </div>
        <div
          style={{
            fontFamily: "var(--font-mono)",
      ...
      <div
        style={{
          ...
          height: 5,
          gap: 2,
          margin: density === "compact" ? "10px 24px 8px" : "14px 32px 10px",
          opacity: 0.22,
        }}
      >
        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => (
          <div
            key={n}
            style={{ flex: 1, background: `var(--bot-${n})`, borderRadius: 2 }}
          />
        ))}
      </div>
      <div
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 13, color: "var(--neutral-5)" }}>
            Sherpy routes you to the right starting step. You can revisit
            earlier steps once running, but you can't skip ahead.
          </div>
          <div
            style={{
              display: "grid",
...
function PathCard({ title, sub, meta, active }) {
  return (
    ...
    >
      ...
      <div
        style={{ fontSize: 11.5, color: "var(--neutral-5)", lineHeight: 1.4 }}
      >
        {sub}
      </div>
    </div>
...
function TrailIllustration() {
  return (
    ...
    >
      ...
      >
        <path
          d="M 0 70 Q 100 50 180 60 Q 260 70 340 40 Q 420 10 520 30 Q 600 45 680 25"
          stroke="var(--neutral-5)"
          strokeWidth="1.5"
          fill="none"
          strokeDasharray="4 5"
        ...
        {[80, 200, 330, 460, 600].map((x, i) => (
          <g key={i}>
            <circle
              cx={x}
              cy={
                i === 0 ? 60 : i === 1 ? 65 : i === 2 ? 50 : i === 3 ? 25 : 30
              }
              r="3"
              fill="var(--neutral-6)"
            />
            <text
              x={x}
              y={i === 0 ? 78 : i === 1 ? 80 : i === 2 ? 68 : i === 3 ? 14 : 18}
              fontSize="9"
              fontFamily="var(--font-mono)"
              fill="var(--neutral-5)"
              textAnchor="middle"
...
function D2_BaseCamp({ density = "cozy", showSpectrum = true }) {
  return (
    ...
    >
      ...
      {showSpectrum && (
        <SpectrumBar active={1} completed={[]} showLabels density={density} />
      )}
      <div
        style={{
          flex: 1,
          padding: density === "compact" ? "6px 32px 20px" : "10px 32px 24px",
          display: "flex",
          flexDirection: "column",
          gap: density === "compact" ? 10 : 14,
          overflow: "hidden",
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 11, color: "var(--neutral-5)" }}>
              2,140 words · 5 sections · pasted just now
            </span>
            <a
              style={{
                marginLeft: "auto",
          ...
          <div
            style={{
              borderTop: "1px dashed var(--neutral-3)",
              paddingTop: 8,
              display: "flex",
              flexDirection: "column",
              gap: 5,
        ...
        >
          ...
          >
            Sherpy reads the doc and surfaces missing pieces (success metrics,
            user roles, constraints). You confirm or fill the gaps, then we move
            into the business interview proper.
          </div>
        </div>
...
function TinyTrail() {
  ...
  return (
    ...
    >
      <path
        d="M 20 30 Q 80 15 130 30 Q 200 45 290 20 Q 380 0 480 20"
        stroke="var(--neutral-5)"
        strokeWidth="1.5"
        fill="none"
        strokeDasharray="4 5"
      ...
      {stops.map((s, i) => (
        <g key={i}>
          ...
          <text
            ...
            fontSize="9"
            fontFamily="var(--font-mono)"
            fill={s.s === "now" ? "var(--accent-2)" : "var(--neutral-5)"}
            textAnchor="middle"
          >
            {s.l}
          </text>
  ...
  return (
    ...
    >
      ...
      <div
        style={{
          flex: 1,
          padding: density === "compact" ? "6px 32px 16px" : "8px 32px 20px",
          display: "flex",
          flexDirection: "column",
          gap: density === "compact" ? 10 : 14,
          minHeight: 0,
      ...
      >
        ...
        >
          Sherpy read the doc and surfaced what's missing. Download the
          worksheet, fill it offline with the right people, then upload the
          filled version — Sherpy will merge the answers in. You can also skip
          and answer these in the interview.
        </div>
        ...
        >
          <div
            style={{
              padding: "8px 14px",
              borderBottom: "1.5px solid var(--neutral-3)",
              background: "var(--neutral-1)",
              display: "flex",
              alignItems: "center",
              gap: 10,
          ...
          <WorksheetGapRow
            n="01"
            cat="Success metrics"
            q="What's the v1 success metric and target value?"
            why="Doc states 'measure outcomes' but no metric defined."
          />
          <WorksheetGapRow
            n="02"
            cat="User roles"
            q="Are there read-only viewers, or is it write-access for everyone?"
            why="PRD lists 'users' once. Permissions implied but not specified."
          />
          <WorksheetGapRow
            n="03"
            cat="Constraints"
            q="Hard launch date — is it a real deadline or directional?"
            why="'Q2 launch' mentioned without commitment language."
          />
          <WorksheetGapRow
            n="04"
            cat="Scope"
            q="Does v1 include billing, or is that a fast-follow?"
            muted
          ...
          <WorksheetGapRow
            n="05"
            cat="Integrations"
            q="Which existing systems must this read from / write to?"
            muted
          />
          <div
            style={{
              padding: "8px 14px",
              borderTop: "1.5px solid var(--neutral-3)",
              display: "flex",
              alignItems: "center",
...
function WorksheetGapRow({ n, cat, q, why, status, muted }) {
  ...
  return (
    <div
      style={{
        display: "grid",
        gridTemplateColumns: "34px 110px 1fr auto",
        gap: 10,
        padding: "9px 14px",
        borderTop: "1px solid var(--neutral-3)",
        alignItems: "start",
    ...
    >
      ...
      >
        <span
          style={{ fontSize: 13, color: "var(--neutral-7)", lineHeight: 1.35 }}
        >
          {q}
        </span>
        {why && (
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Start the business interview now. Sherpy will ask you the
                unfilled gaps inline, one at a time, before moving on.
              </div>
              <button
                style={{
                  marginTop: 4,
      ...
      >
        ...
        >
          ...
          <WorksheetGapRow
            n="01"
            cat="Success metrics"
            q="v1 success metric and target value"
            status="filled"
            why='Answer: "WAU ≥ 200 by week 8 post-launch"'
          />
          <WorksheetGapRow
            n="02"
            cat="User roles"
            q="read-only viewers vs write-access for everyone"
            status="filled"
            why='Answer: "Three roles — admin / editor / viewer"'
          />
          <WorksheetGapRow
            n="03"
            cat="Constraints"
            q="hard launch date — real or directional"
            status="review"
            why='Answer: "Q2" — Sherpy: needs an exact date for sequencing.'
          />
          <WorksheetGapRow
            n="04"
            cat="Scope"
            q="billing in v1, or fast-follow"
            status="filled"
          />
          <WorksheetGapRow
            n="05"
            cat="Integrations"
            q="which existing systems must read/write"
            status="merging"
          />
          <WorksheetGapRow
            n="06"
            cat="Compliance"
            q="any data-residency or audit-log requirements"
            muted
          />
        </div>
      ...
      >
        ...
        >
          ...
          <WorksheetGapRow
            ...
            q="v1 success metric and target value"
            status="filled"
            why="WAU ≥ 200 by week 8 post-launch"
          />
          <WorksheetGapRow
            n="02"
            cat="User roles"
            q="read-only viewers vs write-access for everyone"
            status="filled"
            why="Three roles — admin / editor / viewer"
          />
          <WorksheetGapRow
            n="03"
            cat="Constraints"
          ...
          <WorksheetGapRow
            ...
            q="billing in v1, or fast-follow"
            status="filled"
            why="Fast-follow — billing not in v1"
          />
          <WorksheetGapRow
            n="05"
            cat="Integrations"
            q="which existing systems must read/write"
            status="filled"
            why="Read: GitHub, Slack. Write: Confluence."
          />
        </div>
...
function D2_Thread({ density = "cozy", showSpectrum = true }) {
  return (
    ...
    >
      ...
      />
      {showSpectrum && (
        <SpectrumBar active={2} completed={[1]} showLabels density={density} />
      )}
      <div
        style={{
          flex: 1,
          padding: density === "compact" ? "6px 32px 14px" : "8px 32px 16px",
          display: "flex",
          flexDirection: "column",
          minHeight: 0,
        }}
      >
        ...
        >
          <ThreadDivider
            label="Gap analysis · signed off · 3 gaps resolved"
            tone="success"
          />
          <ThreadMsg
            who="S"
        ...
        >
          ...
          <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
            <SuggChip selected>
              A · Solo engineers shipping side projects
            </SuggChip>
      ...
      >
        ...
        <div
          style={{
            border: "1.5px solid var(--accent-2)",
            borderRadius: 8,
            background: "var(--accent-2-soft, var(--neutral-1))",
            padding: "10px 12px",
            filter: "url(#pencil-soft)",
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            <Eyebrow color="var(--accent-2)">
              Aside · Q4 paused — composer below disabled
            </Eyebrow>
            <span
              style={{
                fontSize: 10,
          ...
          >
            ...
            <span style={{ flex: 1 }}>
              Why does Sherpy ask about the primary user before scope?
            </span>
          </div>
          <div
            style={{
          ...
          >
            ...
            <span style={{ flex: 1, lineHeight: 1.5 }}>
              Outcomes are framed against a primary user. Without one, scope
              decisions later will lack a reference point.
            </span>
          </div>
          <div
            style={{
              borderTop: "1px dashed var(--accent-2)",
              paddingTop: 8,
              display: "flex",
              alignItems: "center",
              gap: 8,
    ...
    <>
      ...
      <DesignCanvas>
        ...
        <DCSection id="d2" title="Direction 02 — Thread (web-app shell)">
          <DCArtboard
            id="d2-all"
            label="Storyboard A→H · gap-analysis cycle"
            width={2120}
            height={tweaks.density === "compact" ? 1820 : 2000}
          >
            <Direction2
...
function BriefCard() {
  return (
    ...
    >
      ...
      >
        Thread — a storyboard for the
        <br /> <em>first 90 seconds</em> of a Sherpy run.
      </div>
      <div
        style={{
          fontSize: 13,
      ...
      >
        The storyboard walks the same beats: <strong>blank state</strong> →{" "}
        <strong>intake</strong> →<strong> gap-analysis cycle</strong> (worksheet
        generated, filled offline, uploaded, merged) →
        <strong> business interview</strong>. Goals: minimal user typing, locked
        into the flow, but flexible — the user can ask Sherpy a question before
        answering, and skip-to-interview is one click away the whole time.
      </div>
      <Line dashed />
      <div
        style={{
      ...
      >
        ...
        <span>
          Standard web-app shell — workspace rail + spectrum bar from the design
          system. Scrollable Q&A thread, composer pinned, suggestions live in
          the composer. Gap-analysis cycle handles offline worksheet
          fill-and-merge before the interview begins.
        </span>
      </div>
      <Line dashed />
      <div
      ...
      >
        <span>
          <strong style={{ color: "var(--neutral-7)" }}>Principles:</strong>{" "}
          medium lock-in (rail visible, can revisit, can't jump ahead) ·
          doc-paste flow detected as the typical entry · gap analysis is
          skippable when the idea is minimal · the ask-back never loses the
          current question.
        </span>
      </div>
      <Note
        style={{ alignSelf: "flex-end", fontSize: 16, marginTop: "auto" }}
        rotate={-3}
      >
        scroll right →
      </Note>
